...
public class EJB32Test extends FATServletClient {

    public static final String SERVER_NAME = "cdi12EJB32FullServer";
    public static final String EJB_MISC_APP_NAME = "ejbMisc";
    ...
    @Server(SERVER_NAME)
    @TestServlets({
                    @TestServlet(servlet = com.ibm.ws.cdi12test.remoteEjb.web.AServlet.class, contextRoot = EJB_MISC_APP_NAME)
    })
    public static LibertyServer server;

    @BeforeClass
    public static void setUp() throws Exception {
        WebArchive ebjMisc = ShrinkWrap.create(WebArchive.class, EJB_MISC_APP_NAME + ".war")
                                       .addClass(com.ibm.ws.cdi12test.remoteEjb.web.AServlet.class)
                                       .addClass(com.ibm.ws.cdi12test.remoteEjb.ejb.TestObserver.class)
                                       .addClass(com.ibm.ws.cdi12test.remoteEjb.api.RemoteInterface.class)
                                       .addClass(com.ibm.ws.cdi12test.remoteEjb.api.EJBEvent.class)
