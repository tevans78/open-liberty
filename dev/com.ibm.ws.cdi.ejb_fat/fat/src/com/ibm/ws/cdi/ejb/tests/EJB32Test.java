...
public class EJB32Test extends FATServletClient {
    ...
    @Server(SERVER_NAME)
    @TestServlets({
                    @TestServlet(servlet = com.ibm.ws.cdi.ejb.apps.misc.AServlet.class, contextRoot = EJB_MISC_APP_NAME)
    })
    ...
    public static void setUp() throws Exception {
        WebArchive ebjMisc = ShrinkWrap.create(WebArchive.class, EJB_MISC_APP_NAME + ".war")
                                       .addClass(com.ibm.ws.cdi.ejb.apps.misc.AServlet.class)
                                       .addClass(com.ibm.ws.cdi.ejb.apps.misc.TestObserver.class)
                                       .addClass(com.ibm.ws.cdi.ejb.apps.misc.RemoteInterface.class)
                                       .addClass(com.ibm.ws.cdi.ejb.apps.misc.EJBEvent.class)
