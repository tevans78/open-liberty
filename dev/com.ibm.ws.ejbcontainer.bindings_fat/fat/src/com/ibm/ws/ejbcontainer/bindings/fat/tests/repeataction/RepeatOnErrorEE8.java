 ...
 *
 */
public class RepeatOnErrorEE8 extends EE8FeatureReplacementAction {

    public static final String ID_EJB_ON_ERROR = EE8FeatureReplacementAction.ID + "_EjbOnErr";
    ...
    private static final Class<?> c = RepeatOnErrorEE8.class;
    String serverName;

    public EjbOnError onErrorAction = EjbOnError.WARN;

    public RepeatOnErrorEE8(EjbOnError ejbOnError) {
