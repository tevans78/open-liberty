...
import com.ibm.ws.cdi.beansxml.implicit.apps.implicitBeanArchive.beans.ApplicationScopedBean;
import com.ibm.ws.cdi.beansxml.implicit.apps.implicitBeanArchive.beans.ConversationScopedBean;
import com.ibm.ws.cdi.beansxml.implicit.apps.implicitBeanArchive.beans.DependentScopedBean;
import com.ibm.ws.cdi.beansxml.implicit.apps.implicitBeanArchive.beans.MyExtendedScopedBean;
import com.ibm.ws.cdi.beansxml.implicit.apps.implicitBeanArchive.beans.RequestScopedBean;
import com.ibm.ws.cdi.beansxml.implicit.apps.implicitBeanArchive.beans.RequestScopedButNoScan;
import com.ibm.ws.cdi.beansxml.implicit.apps.implicitBeanArchive.beans.SessionScopedBean;
import com.ibm.ws.cdi.beansxml.implicit.apps.implicitBeanArchive.beans.StereotypedBean;
import com.ibm.ws.cdi.beansxml.implicit.apps.implicitBeanArchive.unannotated.UnannotatedClassInAnnotatedModeBeanArchive;
import com.ibm.ws.cdi.beansxml.implicit.apps.implicitBeanArchive.unannotated.UnannotatedClassInImplicitBeanArchive;
import com.ibm.ws.cdi.beansxml.implicit.apps.implicitBeanArchive.unannotated.UnannotatedClassWithInject;
...
public class ImplicitBeanArchiveServlet extends FATServlet {
    ...
    public void testUnannotatedBeanInAllModeBeanArchive() {
        ...
        Set<Bean<?>> unannotatedBeanInAllModeBeanArchive = beanManager.getBeans(APlainClass.class);
    ...
    public void testUnannotatedBeanInImplicitArchive() {
        ...
        Set<Bean<?>> unannotatedBeanInImplicitBeanArchive = beanManager.getBeans(UnannotatedClassInImplicitBeanArchive.class);
    ...
    public void testClassWithInjectButNotInABeanArchive() {
        //this one is not an implicit bean and has no beans.xml so it should be null
        Set<Bean<?>> classWithInjectButNotABean = beanManager.getBeans(UnannotatedClassWithInject.class);
