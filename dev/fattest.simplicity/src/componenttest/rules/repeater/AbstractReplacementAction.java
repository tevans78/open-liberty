 ...
 *
 * An abstract implementation of RepeatTestAction which uses generics to maintain the
 * correct return types for concrete implementations that extend it.
 *
 * @param <T> The concrete sub-type
 */
public abstract class AbstractReplacementAction<T extends AbstractReplacementAction> implements RepeatTestAction {

    private static final Class<?> c = AbstractReplacementAction.class;
    ...
    public AbstractReplacementAction() {}
     ...
     */
    public AbstractReplacementAction(String removeFeature, String addFeature) {
        this();
     ...
     */
    public AbstractReplacementAction(Set<String> removeFeatures, Set<String> addFeatures) {
        this();
     ...
     * @param addFeatures the features to add
     */
    public AbstractReplacementAction(Set<String> addFeatures) {
        this();
        addFeatures(addFeatures);
    }
     ...
     * @param addFeature the feature to add.
     */
    public AbstractReplacementAction(String addFeature) {
        this();
        addFeature(addFeature);
    }
     ...
     */
    public static EE7FeatureReplacementAction EE7_FEATURES() {
     ...
     */
    public static EE8FeatureReplacementAction EE8_FEATURES() {
     ...
     */
    public static JakartaEE9Action EE9_FEATURES() {
     ...
     */
    public static JakartaEE10Action EE10_FEATURES() {
    ...
    public T addFeatures(Set<String> addFeatures) {
     ...
     */
    @SuppressWarnings("unchecked")
    public T alwaysAddFeatures(Set<String> alwaysAddedFeatures) {
     ...
     */
    @SuppressWarnings("unchecked")
    public T alwaysAddFeature(String alwaysAddedFeature) {
     ...
     */
    @SuppressWarnings("unchecked")
    public T removeFeatures(Set<String> removeFeatures) {
     ...
     */
    @SuppressWarnings("unchecked")
    public T addFeature(String addFeature) {
     ...
     */
    @SuppressWarnings("unchecked")
    public T removeFeature(String removeFeature) {
     ...
     */
    @SuppressWarnings("unchecked")
    public T withMinJavaLevel(int javaLevel) {
        this.minJavaLevel = javaLevel;
        return (T) this;
    }

    /**
     * Define that this action should only be run in FULL mode
     */
    public T fullFATOnly() {
        return withTestMode(TestMode.FULL);
    }

    /**
     * Define that this action should only be run in LITE mode
     */
    public T liteFATOnly() {
        return withTestMode(TestMode.LITE);
    }

    /**
     * Defines that this action should only be run in the specified TestMode
     */
    @SuppressWarnings("unchecked")
    public T withTestMode(TestMode mode) {
        this.testRunMode = mode;
        this.liteFATOnly = TestMode.LITE == mode;
        return (T) this;
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public T forServers(String... serverNames) {
     ...
     */
    @SuppressWarnings("unchecked")
    public T forClients(String... clientNames) {
     ...
     * @return             This {@link AbstractReplacementAction} instance.
     */
    @SuppressWarnings("unchecked")
    public T forServerConfigPaths(String... serverPaths) {
        if (calledForServers) {
            throw new IllegalStateException("Use only one of forServers(...) and forServerConfigPaths(...)");
        }
     ...
     */
    @SuppressWarnings("unchecked")
    public T forceAddFeatures(boolean force) {
        this.forceAddFeatures = force;
        return (T) this;
    }

    /**
     * Defines the ID which should be used by this action. The ID should be unique.
     * This is the ID which can be used in annotations such as @SkipForRepeat
     */
    @SuppressWarnings("unchecked")
