...
/**
 * This class contains settings specific to configuring an LDAP user registry on the global security
 * domain.
 */
public class AdminLDAPSettings extends LDAPSettings implements AdminUserRegistrySettings {
