...
/**
 * This class contains settings used to configure the admin custom user registry in the global
 * security domain.
 */
public class AdminCustomSettings extends CustomSettings implements AdminUserRegistrySettings {
