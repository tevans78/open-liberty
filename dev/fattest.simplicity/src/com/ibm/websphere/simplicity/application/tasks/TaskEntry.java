...
public abstract class TaskEntry {
	...
	protected String getPropName() {
		return getString(AppConstants.APPDEPL_PROP_NAME);
	}
	
	protected String getPropType() {
		return getString(AppConstants.APPDEPL_PROP_TYPE);
	}
	
	protected String getPropDesc() {
		return getString(AppConstants.APPDEPL_PROP_DESC);
	}
	
	protected String getPropValue() {
		return getString(AppConstants.APPDEPL_PROP_VALUE);
	}
	...
	protected void setPropValue(String value) {
		setItem(AppConstants.APPDEPL_PROP_VALUE, value);
	}
