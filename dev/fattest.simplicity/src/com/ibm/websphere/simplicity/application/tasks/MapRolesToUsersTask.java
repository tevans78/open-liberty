...
public class MapRolesToUsersTask extends MultiEntryApplicationTask {
	...
	private void setRoleMap(String role, boolean everyone, boolean allAuthenticatedRealms, boolean allAuthenticatedUsers, String group, String groupAccessIds, String user, String userAccessIds) throws Exception {
        modified = true;
        MapRolesToUsersEntry entry = getRoleMapInternal(role);
