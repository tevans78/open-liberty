...
public class InstallApplication extends Job {
	...
	/**
	 * Install an application.  This version is deprecated because the
	 * serverName parameter should be optional.
	 * @param serverName Name of the server where the application will run.
	 * @param applicationName Name of the application to install.
	 */
	@Deprecated
	public InstallApplication(String serverName, String applicationName) {
		super(JobType.InstallApplication);
	 ...
	 * @param applicationName Name of the application to install.
	 */
	public InstallApplication(String applicationName) {
		super(JobType.InstallApplication);
		setApplicationName(applicationName);
	}
