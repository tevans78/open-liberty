 ...
 */
public class SetIdMgrLDAPContextPool extends Command {

	private Boolean enabled = false;
	private String id;
	private Integer initPoolSize = 1;
	private Integer maxPoolSize = 20;
	private Integer poolTimeOut = 0;
	private Integer poolWaitTime = 3000;
	private Integer prefPoolSize = 3;

	public SetIdMgrLDAPContextPool(String id) {
		super("setIdMgrLDAPContextPool");
		this.id = id;
	}
