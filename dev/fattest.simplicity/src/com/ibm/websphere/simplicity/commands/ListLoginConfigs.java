 ...
 *   'loginModuleType': Enter a login module type. Valid types are: system and application.
 * The required parameters are found in the constructor.
 */
public class ListLoginConfigs extends Command {

	private String loginModuleType;

	public ListLoginConfigs(String loginModuleType) {
	 ...
	 * Enter a login module type. Valid types are: system and application.
	 */
	public void setLoginModuleType(String value) {
		this.loginModuleType = value;
	}

	public Properties __getParameters() {
		Properties ret = new Properties();
		ret.put("loginModuleType", this.loginModuleType);
		return ret;
	}
