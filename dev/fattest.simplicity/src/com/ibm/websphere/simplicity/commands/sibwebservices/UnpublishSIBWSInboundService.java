 ...
 *   'userId': User ID to be used if unpublishing is done through an authenticating proxy.
 *   'password': Password to be used if unpublishing is done through an authenticating proxy.
 * The required parameters are found in the constructor.
 */
public class UnpublishSIBWSInboundService extends Command {
	...
	public UnpublishSIBWSInboundService(com.ibm.websphere.simplicity.ConfigIdentifier commandTarget, String uddiPublication) {
