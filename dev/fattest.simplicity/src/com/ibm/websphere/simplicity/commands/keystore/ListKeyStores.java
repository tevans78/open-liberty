 ...
 *   'keyStoreUsage': List keystores for a particular usage.
 *   'scopeName': Specifies the management scope.
 *   'all': Specify true to list all keystores.  True overrides the scopeName parameter.
 * The required parameters are found in the constructor.
 */
public class ListKeyStores extends Command {
