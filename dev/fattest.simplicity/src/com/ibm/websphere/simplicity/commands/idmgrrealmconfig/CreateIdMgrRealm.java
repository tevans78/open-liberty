 ...
 */
public class CreateIdMgrRealm extends Command {

	private Boolean allowOperationIfReposDown = false;
	private String delimiter = "/";
	private String name;
	private String securityUse = "active";

	public CreateIdMgrRealm(String name) {
		super("createIdMgrRealm");
		this.name = name;
	}
