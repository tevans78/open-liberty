 ...
 */
public class RemoveGroupFromTopicRole extends Command {
	...
	public RemoveGroupFromTopicRole(String bus, String topicSpace, String topic, String role, String group) {
		super("removeGroupFromTopicRole");
		this.bus = bus;
