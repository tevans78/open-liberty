 ...
 *   'dynamicClient': Indicates that the client resources should not be validated.  The default value for this parameter is false. (Boolean)
 *   'attachmentProperties': The attachment specific properties (Properties)
 * The required parameters are found in the constructor.
 */
public class AddToPolicySetAttachment extends Command {

	private String applicationName;
	private String attachmentId;
	private java.lang.String[] resources;
	private String attachmentType;
	private Boolean dynamicClient;
	private java.util.Properties attachmentProperties;

	public AddToPolicySetAttachment(String attachmentId, java.lang.String[] resources) {
		super("addToPolicySetAttachment");
	 ...
	 */
	public Boolean getDynamicClient() {
	 ...
	 * Indicates that the client resources should not be validated.  The default value for this parameter is false. (Boolean)
	 */
	public void setDynamicClient(Boolean value) {
		this.dynamicClient = value;
	}
	...
	public Properties __getParameters() {
		...
		if (this.dynamicClient != null) {
			ret.put("dynamicClient", this.dynamicClient);
		}
