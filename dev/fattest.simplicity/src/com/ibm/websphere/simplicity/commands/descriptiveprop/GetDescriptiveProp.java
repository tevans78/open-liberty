 ...
 */
public class GetDescriptiveProp extends Command {
	...
	public GetDescriptiveProp(String name, String parentDataType, String parentClassName) {
		super("getDescriptiveProp");
		this.name = name;
