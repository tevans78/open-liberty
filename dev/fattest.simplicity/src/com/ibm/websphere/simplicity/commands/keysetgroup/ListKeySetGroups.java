 ...
 *   'all': Specify true to list all key set groups.  True overrides the scopeName parameter.
 * The required parameters are found in the constructor.
 */
public class ListKeySetGroups extends Command {

	private String scopeName;
	private Boolean displayObjectName = false;
	private Boolean all = false;

	public ListKeySetGroups() {
