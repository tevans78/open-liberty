 ...
 * Use the dpWaitForTaskEnd command to wait for a DataPower appliance manager task to end.
 *   'taskId': Specifies the ID of the task of interest in the DataPower appliance manager.
 * The required parameters are found in the constructor.
 */
public class DpWaitForTaskEnd extends Command {

	private String taskId;

	public DpWaitForTaskEnd(String taskId) {
		super("dpWaitForTaskEnd");
		this.taskId = taskId;
	}
