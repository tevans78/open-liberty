 ...
 */
public class CreateAuditEncryptionConfig extends Command {
	...
	public CreateAuditEncryptionConfig(String certAlias, Boolean enableAuditEncryption, String encryptionKeyStoreRef) {
		super("createAuditEncryptionConfig");
		this.certAlias = certAlias;
		this.enableAuditEncryption = enableAuditEncryption;
		this.encryptionKeyStoreRef = encryptionKeyStoreRef;
	}
