 ...
 */
public class CreateWebServerTemplate extends Command {
	...
	public CreateWebServerTemplate(String templateName, String serverName, String nodeName) {
		super("createWebServerTemplate");
