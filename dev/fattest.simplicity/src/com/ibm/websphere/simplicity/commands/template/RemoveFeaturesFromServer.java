 ...
 * templates.removeFeature.description
 *   'nodeName': Node name of server
 *   'serverName': Server name which require update with features being removed
 *   'featureTemplateName': Feature pack or stack product template that needs to be removed from the server
 *   'serverType': Servertype of Feature pack or stack product template that needs to be added to the server
 * The required parameters are found in the constructor.
 */
public class RemoveFeaturesFromServer extends Command {
	...
	public RemoveFeaturesFromServer(String nodeName, String featureTemplateName, String serverType) {
