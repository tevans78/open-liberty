 ...
 *   'mediationName': Name of the mediation to be modified.
 ...
 */
public class ModifySIBMediation extends Command {
	...
	private Boolean allowConcurrentMediation;
	private String selector;
	private String discriminator;

	public ModifySIBMediation(String bus, String mediationName) {
		super("modifySIBMediation");
		this.bus = bus;
	...
	/**
	 * Name of the mediation to be modified.
	 */
