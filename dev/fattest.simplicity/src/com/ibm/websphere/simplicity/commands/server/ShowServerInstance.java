 ...
 *   'propertyName': See command setServerInstance for supported property names. If this parameter is not specified, then all properties are shown.
 * The required parameters are found in the constructor.
 */
public class ShowServerInstance extends Command {

	private String serverName;
	private String nodeName;
	private String propertyName;

	public ShowServerInstance() {
