 ...
 *   'cacheSize': The cache size for search.
 ...
 */
public class SetIdMgrLDAPSearchResultCache extends Command {

	private Boolean cachesDiskOffLoad = false;
	private String id;
	private Boolean enabled = true;
	private Integer cacheSize = 2000;
	private Integer cacheTimeOut = 600;
	private Integer searchResultSizeLimit = 1000;

	public SetIdMgrLDAPSearchResultCache(String id) {
		super("setIdMgrLDAPSearchResultCache");
		this.id = id;
	}
