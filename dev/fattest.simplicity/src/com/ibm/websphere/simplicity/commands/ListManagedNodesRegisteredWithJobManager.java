 ...
 * List one registered managed nodes's data if a name is given, otherwise list all managed nodes registered with the job manager data
 *   'managedNodeName': Name of the managed node by which JobManagers are looked up
 * The required parameters are found in the constructor.
 */
public class ListManagedNodesRegisteredWithJobManager extends Command {

	private String managedNodeName;

	public ListManagedNodesRegisteredWithJobManager() {
