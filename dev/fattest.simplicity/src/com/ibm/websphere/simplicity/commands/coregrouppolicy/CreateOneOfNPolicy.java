 ...
 */
public class CreateOneOfNPolicy extends Command {
	...
	public CreateOneOfNPolicy(String coreGroupName, String policyName, java.util.Properties matchCriteria) {
		super("createOneOfNPolicy");
