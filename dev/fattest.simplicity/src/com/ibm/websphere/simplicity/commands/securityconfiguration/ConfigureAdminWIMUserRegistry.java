 ...
 * Configures a WIM user registry in the administrative security configuration.
 ...
 */
public class ConfigureAdminWIMUserRegistry extends Command {
	...
	public ConfigureAdminWIMUserRegistry() {
