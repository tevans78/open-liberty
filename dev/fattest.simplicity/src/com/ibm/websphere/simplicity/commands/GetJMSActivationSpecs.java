 ...
 */
public class GetJMSActivationSpecs extends Command {

	private com.ibm.websphere.simplicity.ConfigIdentifier __target;
	private List<Command> __steps;
	private java.lang.Boolean allscopes;

	public GetJMSActivationSpecs(com.ibm.websphere.simplicity.ConfigIdentifier commandTarget, java.lang.Boolean allscopes) {
		super("getJMSActivationSpecs");
	 ...
	 */
	public OperationResults<Object> run(Scope scope, GetSIBJMSActivationSpecs getSIBJMSActivationSpecs) throws Exception {
		this.__steps = new ArrayList<Command>();
		if (getSIBJMSActivationSpecs != null)
			this.__steps.add(getSIBJMSActivationSpecs);
	 ...
	 * The required parameters are found in the constructor.
	 */
	public static class GetSIBJMSActivationSpecs extends CommandStep {

		public GetSIBJMSActivationSpecs() {
			super("getSIBJMSActivationSpecs");
		}
