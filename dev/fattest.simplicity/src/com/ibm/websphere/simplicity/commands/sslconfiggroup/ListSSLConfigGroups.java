 ...
 *   'all': Specify true to list all SSL configuration groups.  True overrides the scopeName parameter.
 * The required parameters are found in the constructor.
 */
public class ListSSLConfigGroups extends Command {
