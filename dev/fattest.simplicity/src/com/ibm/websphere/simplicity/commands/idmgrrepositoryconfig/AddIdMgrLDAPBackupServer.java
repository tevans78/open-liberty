 ...
 */
public class AddIdMgrLDAPBackupServer extends Command {
	...
	public AddIdMgrLDAPBackupServer(String host, String id, String primary_host) {
		super("addIdMgrLDAPBackupServer");
		this.host = host;
		this.id = id;
