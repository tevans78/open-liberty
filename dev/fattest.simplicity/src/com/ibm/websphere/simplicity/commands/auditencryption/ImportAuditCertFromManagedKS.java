 ...
 *   'fromKeyStoreName': Keystore object from which the certificate will be imported.
 *   'fromKeyStorePassword': Password of the keystore object from which the certificate will be imported.
 ...
 *   'fromKeyStoreScope': The scope name of the keystore object from which the certificate will be imported.
 *   'certificateAlias': Unique name used to identify the certificate in the destination keystore.
 * The required parameters are found in the constructor.
 */
public class ImportAuditCertFromManagedKS extends Command {
	...
	public ImportAuditCertFromManagedKS(String fromKeyStoreName, String fromKeyStorePassword, String certificateAliasFromKeyStore, String keyStoreName) {
