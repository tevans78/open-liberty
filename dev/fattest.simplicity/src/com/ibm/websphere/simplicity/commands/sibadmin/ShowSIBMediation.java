 ...
 *   'mediationName': The name of the mediation to be shown.
 * The required parameters are found in the constructor.
 */
public class ShowSIBMediation extends Command {

	private String bus;
	private String mediationName;

	public ShowSIBMediation(String bus, String mediationName) {
