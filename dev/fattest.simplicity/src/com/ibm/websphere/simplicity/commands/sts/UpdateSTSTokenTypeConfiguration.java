 ...
 */
public class UpdateSTSTokenTypeConfiguration extends Command {
	...
	private String tokenCacheFactory;
	private Boolean postdatable;
	private Boolean renewableAfterExpiration;
	private Integer renewalWindowMinutes;
	private java.util.Properties customProperties;

	public UpdateSTSTokenTypeConfiguration(String commandTarget) {
		super("updateSTSTokenTypeConfiguration");
