 ...
 */
public class RemoveGroupFromForeignBusRole extends Command {
	...
	public RemoveGroupFromForeignBusRole(String bus, String foreignBus, String role, String group) {
		super("removeGroupFromForeignBusRole");
		this.bus = bus;
