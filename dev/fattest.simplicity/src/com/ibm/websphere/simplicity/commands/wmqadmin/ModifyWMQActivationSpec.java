 ...
 * Modifies the properties of the WMQ Activation Specification provided to the command.
 ...
 */
public class ModifyWMQActivationSpec extends Command {
	...
	public ModifyWMQActivationSpec(com.ibm.websphere.simplicity.ConfigIdentifier commandTarget) {
		super("modifyWMQActivationSpec");
