 ...
 */
public class CreateAuditSigningConfig extends Command {
	...
	public CreateAuditSigningConfig(String certAlias, Boolean enableAuditSigning, String signingKeyStoreRef) {
		super("createAuditSigningConfig");
		this.certAlias = certAlias;
		this.enableAuditSigning = enableAuditSigning;
		this.signingKeyStoreRef = signingKeyStoreRef;
	}
