 ...
 *   'expandResources': Provides expanded information that details the attachment properties for each resource. An asterisk (*) character returns all Web services. (String)
 *   'attachmentProperties': The attachment specific properties (Properties)
 * The required parameters are found in the constructor.
 */
public class GetPolicySetAttachments extends Command {

	private String applicationName;
	private String attachmentType;
	private String expandResources;
	private java.util.Properties attachmentProperties;

	public GetPolicySetAttachments() {
	 ...
	 * Provides expanded information that details the attachment properties for each resource. An asterisk (*) character returns all Web services. (String)
	 */
	public void setExpandResources(String value) {
		this.expandResources = value;
	}
	...
	public Properties __getParameters() {
		...
		if (this.expandResources != null) {
			ret.put("expandResources", this.expandResources);
		}
