 ...
 */
public class DpCopyMSDomainVersion extends Command {

	private String managedSetId;
	private String msDomainVersionId;

	public DpCopyMSDomainVersion(String managedSetId, String msDomainVersionId) {
		super("dpCopyMSDomainVersion");
