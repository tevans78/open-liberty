 ...
 */
public class CreateKrbAuthMechanism extends Command {
	...
	private String serviceName = "WAS";
	private Boolean trimUserName = true;

	public CreateKrbAuthMechanism(Boolean allowKrbAuthForCsiInbound, Boolean allowKrbAuthForCsiOutbound, String krb5Config, String serviceName, Boolean trimUserName) {
		super("createKrbAuthMechanism");
		this.allowKrbAuthForCsiInbound = allowKrbAuthForCsiInbound;
		this.allowKrbAuthForCsiOutbound = allowKrbAuthForCsiOutbound;
		this.krb5Config = krb5Config;
		this.serviceName = serviceName;
		this.trimUserName = trimUserName;
	}
