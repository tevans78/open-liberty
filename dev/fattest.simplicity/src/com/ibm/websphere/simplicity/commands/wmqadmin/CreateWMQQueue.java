 ...
 * Creates a WMQ Queue at the scope provided to the command.
 ...
 */
public class CreateWMQQueue extends Command {
	...
	private String readAhead = "QDEF";
	private String sendAsync = "QDEF";
	private Boolean useRFH2 = true;
	private Boolean useNativeEncoding = true;

	public CreateWMQQueue(com.ibm.websphere.simplicity.ConfigIdentifier commandTarget, String jndiName, String name, String queueName) {
		super("createWMQQueue");
