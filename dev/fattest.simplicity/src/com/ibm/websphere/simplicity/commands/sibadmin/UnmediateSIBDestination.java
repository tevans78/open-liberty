 ...
 *   'bus': The name of the bus where the destination is currently mediated.
 *   'destinationName': The name of the destination to be unmediated.
 * The required parameters are found in the constructor.
 */
public class UnmediateSIBDestination extends Command {

	private String bus;
	private String destinationName;

	public UnmediateSIBDestination(String bus, String destinationName) {
