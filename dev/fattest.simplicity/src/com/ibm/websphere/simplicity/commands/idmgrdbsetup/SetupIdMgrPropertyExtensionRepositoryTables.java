 ...
 *   'laPropXML': The location of property extension repository property definition xml file.
 ...
 */
public class SetupIdMgrPropertyExtensionRepositoryTables extends Command {
	...
	private String laPropXML;
	private String reportSqlError;
	private String schemaLocation;

	public SetupIdMgrPropertyExtensionRepositoryTables() {
	 ...
	 */
	public String getLaPropXML() {
		return this.laPropXML;
	}

	/**
	 * The location of property extension repository property definition xml file.
	 */
	public void setLaPropXML(String value) {
		this.laPropXML = value;
	}
	...
	public Properties __getParameters() {
		...
		if (this.laPropXML != null) {
			ret.put("laPropXML", this.laPropXML);
		}
