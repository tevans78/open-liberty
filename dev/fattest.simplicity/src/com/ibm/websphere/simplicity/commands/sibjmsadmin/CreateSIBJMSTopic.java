 ...
 */
public class CreateSIBJMSTopic extends Command {
	...
	public CreateSIBJMSTopic(com.ibm.websphere.simplicity.ConfigIdentifier commandTarget, String name, String jndiName) {
