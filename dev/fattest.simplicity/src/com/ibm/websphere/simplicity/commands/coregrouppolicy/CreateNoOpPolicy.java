 ...
 */
public class CreateNoOpPolicy extends Command {
	...
	public CreateNoOpPolicy(String coreGroupName, String policyName, java.util.Properties matchCriteria) {
		super("createNoOpPolicy");
