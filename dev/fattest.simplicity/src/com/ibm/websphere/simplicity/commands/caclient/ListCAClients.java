 ...
 *   'all': Specify true to list all certificate authority (CA) configurator objects. (Overrides the scopeName parameter if true.)
 * The required parameters are found in the constructor.
 */
public class ListCAClients extends Command {

	private String scopeName;
	private Boolean all = false;

	public ListCAClients() {
		super("listCAClients");
	}
