 ...
 *   'customProperties': WSS Distributed Cache Config Custom Properties
 * The required parameters are found in the constructor.
 */
public class UpdateWSSDistributedCacheCustomConfig extends Command {

	private java.util.Properties customProperties;

	public UpdateWSSDistributedCacheCustomConfig() {
