 ...
 */
public class CreateSIBLink extends Command {
	...
	public CreateSIBLink(String bus, String messagingEngine, String name, String foreignBusName, String remoteMessagingEngineName) {
		super("createSIBLink");
		this.bus = bus;
		this.messagingEngine = messagingEngine;
		this.name = name;
		this.foreignBusName = foreignBusName;
		this.remoteMessagingEngineName = remoteMessagingEngineName;
	}
