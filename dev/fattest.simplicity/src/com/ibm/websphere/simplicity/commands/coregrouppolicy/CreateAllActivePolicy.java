 ...
 */
public class CreateAllActivePolicy extends Command {
	...
	public CreateAllActivePolicy(String coreGroupName, String policyName, java.util.Properties matchCriteria) {
