 ...
 */
public class GetJMSQueueConnectionFactories extends Command {

	private com.ibm.websphere.simplicity.ConfigIdentifier __target;
	private List<Command> __steps;
	private java.lang.Boolean allscopes;

	public GetJMSQueueConnectionFactories(com.ibm.websphere.simplicity.ConfigIdentifier commandTarget, java.lang.Boolean allscopes) {
		super("getJMSQueueConnectionFactories");
	 ...
	 */
	public OperationResults<Object> run(Scope scope, GetSIBJMSQueueConnectionFactories getSIBJMSQueueConnectionFactories) throws Exception {
		this.__steps = new ArrayList<Command>();
		if (getSIBJMSQueueConnectionFactories != null)
			this.__steps.add(getSIBJMSQueueConnectionFactories);
	 ...
	 * The required parameters are found in the constructor.
	 */
	public static class GetSIBJMSQueueConnectionFactories extends CommandStep {

		public GetSIBJMSQueueConnectionFactories() {
			super("getSIBJMSQueueConnectionFactories");
		}
