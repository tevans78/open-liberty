 ...
 * This command unconfigures the embedded Tivoli Access Manager Trust Association Interceptor with classname TAMTrustAsociationInterceptorPlus. This task does not include removing
 * any custom properties from the security configuration
 ...
 */
public class UnconfigureTAMTAI extends Command {
    ...
    public UnconfigureTAMTAI(String adminPasswd) {
