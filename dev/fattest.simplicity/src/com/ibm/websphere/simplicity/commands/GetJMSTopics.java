 ...
 */
public class GetJMSTopics extends Command {

	private com.ibm.websphere.simplicity.ConfigIdentifier __target;
	private List<Command> __steps;
	private java.lang.Boolean allscopes;

	public GetJMSTopics(com.ibm.websphere.simplicity.ConfigIdentifier commandTarget, java.lang.Boolean allscopes) {
		super("getJMSTopics");
	 ...
	 */
	public OperationResults<Object> run(Scope scope, GetSIBJMSTopics getSIBJMSTopics) throws Exception {
		this.__steps = new ArrayList<Command>();
		if (getSIBJMSTopics != null)
			this.__steps.add(getSIBJMSTopics);
	 ...
	 * The required parameters are found in the constructor.
	 */
	public static class GetSIBJMSTopics extends CommandStep {

		public GetSIBJMSTopics() {
			super("getSIBJMSTopics");
		}
