 ...
 * The removeEventServiceDerbyDB command removes the Event Service database and data source for Derby from a server or cluster.
 ...
 */
public class RemoveEventServiceDerbyDB extends Command {
	...
	public RemoveEventServiceDerbyDB() {
		super("removeEventServiceDerbyDB");
	}
