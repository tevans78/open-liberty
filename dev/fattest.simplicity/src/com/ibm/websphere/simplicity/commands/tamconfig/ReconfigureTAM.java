 ...
 */
public class ReconfigureTAM extends Command {
    ...
    private String defer = "yes";

    public ReconfigureTAM(String policySvr, String authSvrs, String wasAdminDN, String dnSuffix, String adminPasswd) {
