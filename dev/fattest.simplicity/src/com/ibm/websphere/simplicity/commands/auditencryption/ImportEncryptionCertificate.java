 ...
 */
public class ImportEncryptionCertificate extends Command {
	...
	public ImportEncryptionCertificate(String certificateAliasFromKeyFile, String keyFilePath, String keyFilePassword, String keyFileType, String keyStoreName) {
		super("importEncryptionCertificate");
