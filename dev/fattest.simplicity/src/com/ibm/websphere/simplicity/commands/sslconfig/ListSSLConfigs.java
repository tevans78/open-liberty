 ...
 *   'all': Specify true to list all SSL configurations.  True overrides the scopeName parameter.
 * The required parameters are found in the constructor.
 */
public class ListSSLConfigs extends Command {

	private String scopeName;
	private Boolean displayObjectName = false;
	private Boolean all = false;

	public ListSSLConfigs() {
