 ...
 */
public class SetIdMgrEntryMappingRepository extends Command {
	...
	public SetIdMgrEntryMappingRepository(String dataSourceName, String databaseType, String dbURL) {
		super("setIdMgrEntryMappingRepository");
