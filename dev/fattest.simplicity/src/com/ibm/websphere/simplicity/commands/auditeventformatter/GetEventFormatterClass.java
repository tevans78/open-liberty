...
package com.ibm.websphere.simplicity.commands.auditeventformatter;
 ...
 */
public class GetEventFormatterClass extends Command {

	private String emitterRef;

	public GetEventFormatterClass(String emitterRef) {
