 ...
 *   'customProperties': Specifies a comma separated list of attribute=value custom property pairs to be modified on the CAClient object.  The properties can be created, modified, or removed.
 ...
 */
public class ModifyCAClient extends Command {
	...
	public ModifyCAClient(String caClientName) {
	...
	public Properties __getParameters() {
		...
		if (this.pkiClientImplClass != null) {
