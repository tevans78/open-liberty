 ...
 */
public class GetJMSQueues extends Command {

	private com.ibm.websphere.simplicity.ConfigIdentifier __target;
	private List<Command> __steps;
	private java.lang.Boolean allscopes;

	public GetJMSQueues(com.ibm.websphere.simplicity.ConfigIdentifier commandTarget, java.lang.Boolean allscopes) {
		super("getJMSQueues");
	 ...
	 */
	public OperationResults<Object> run(Scope scope, GetSIBJMSQueues getSIBJMSQueues) throws Exception {
		this.__steps = new ArrayList<Command>();
		if (getSIBJMSQueues != null)
			this.__steps.add(getSIBJMSQueues);
	 ...
	 * The required parameters are found in the constructor.
	 */
	public static class GetSIBJMSQueues extends CommandStep {

		public GetSIBJMSQueues() {
			super("getSIBJMSQueues");
		}
