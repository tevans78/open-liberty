 ...
 * Shows information on the specified software package.
 *   'packageName': Specifies the short name of the software package.
 * The required parameters are found in the constructor.
 */
public class ShowPackageInfo extends Command {

	private String packageName;

	public ShowPackageInfo(String packageName) {
		super("showPackageInfo");
