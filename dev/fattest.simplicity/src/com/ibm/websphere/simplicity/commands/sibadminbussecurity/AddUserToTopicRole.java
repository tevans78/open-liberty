 ...
 */
public class AddUserToTopicRole extends Command {
	...
	public AddUserToTopicRole(String bus, String topicSpace, String topic, String role, String user) {
		super("addUserToTopicRole");
		this.bus = bus;
