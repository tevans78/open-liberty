 ...
 */
public class CreateDescriptiveProp extends Command {
	...
	public CreateDescriptiveProp(String name, String type, String value, String parentDataType, String parentClassName) {
		super("createDescriptiveProp");
		this.name = name;
		this.type = type;
		this.value = value;
