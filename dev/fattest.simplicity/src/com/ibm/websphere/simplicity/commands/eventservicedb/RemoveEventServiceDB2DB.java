 ...
 * The removeEventServiceDB2DB command removes the Event Service database and data sources for DB2 from a server or cluster.
 ...
 *   'dbUser': DB2 user ID that has privileges to create and drop the databases. This parameter must be set when the parameter removeDB is set to true. The default value is db2inst1 if not specified.
 ...
 */
public class RemoveEventServiceDB2DB extends Command {
	...
	public RemoveEventServiceDB2DB() {
		super("removeEventServiceDB2DB");
	}
