 ...
 *   'interceptor': Class name of the interceptor.
 * The required parameters are found in the constructor.
 */
public class UnconfigureInterceptor extends Command {

	private String securityDomainName;
	private String interceptor;

	public UnconfigureInterceptor(String interceptor) {
	 ...
	 * Class name of the interceptor.
	 */
	public void setInterceptor(String value) {
	...
	public Properties __getParameters() {
		...
		ret.put("interceptor", this.interceptor);
		return ret;
	}
