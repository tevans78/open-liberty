 ...
 *   'nodeName': the name of the node to be removed from the node group
 * The required parameters are found in the constructor.
 */
public class RemoveNodeGroupMember extends Command {

	private String __target;
	private String nodeName;

	public RemoveNodeGroupMember(String commandTarget, String nodeName) {
