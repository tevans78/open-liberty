 ...
 */
public class ExtractCertificate extends Command {
	...
	public ExtractCertificate(String certificateFilePath, String keyStoreName, Boolean base64Encoded, String certificateAlias) {
		super("extractCertificate");
