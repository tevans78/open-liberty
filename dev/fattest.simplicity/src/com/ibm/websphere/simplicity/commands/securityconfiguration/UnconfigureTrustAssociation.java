 ...
 * Removes the trust association object form a security domain.
 *   'securityDomainName': Name used to uniquely identify the security domain.
 * The required parameters are found in the constructor.
 */
public class UnconfigureTrustAssociation extends Command {

	private String securityDomainName;

	public UnconfigureTrustAssociation(String securityDomainName) {
