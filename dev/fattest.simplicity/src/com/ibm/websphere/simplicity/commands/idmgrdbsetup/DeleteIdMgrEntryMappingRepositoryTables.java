 ...
 */
public class DeleteIdMgrEntryMappingRepositoryTables extends Command {
	...
	public DeleteIdMgrEntryMappingRepositoryTables() {
		super("deleteIdMgrEntryMappingRepositoryTables");
	}
