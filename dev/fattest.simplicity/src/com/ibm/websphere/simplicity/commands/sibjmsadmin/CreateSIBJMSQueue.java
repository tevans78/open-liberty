 ...
 */
public class CreateSIBJMSQueue extends Command {
	...
	public CreateSIBJMSQueue(com.ibm.websphere.simplicity.ConfigIdentifier commandTarget, String name, String jndiName, String queueName) {
