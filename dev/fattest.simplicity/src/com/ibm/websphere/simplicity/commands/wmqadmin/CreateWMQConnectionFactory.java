 ...
 * Creates a WMQ Connection Factory at the scope provided to the command.
 ...
 */
public class CreateWMQConnectionFactory extends Command {
	...
	private Boolean support2PCProtocol = true;
	private String tempQueuePrefix;
	private String tempTopicPrefix;
	private String type = "CF";
	private String wildcardFormat;
	private String wmqTransportType;
	private String xaRecoveryAuthAlias;

	public CreateWMQConnectionFactory(com.ibm.websphere.simplicity.ConfigIdentifier commandTarget, String jndiName, String name, String type) {
