 ...
 */
public class SetIdMgrLDAPAttrCache extends Command {

	private Integer cacheSize = 4000;
	private Integer cacheTimeOut = 1200;
	private Boolean enabled = true;
	private Integer attributeSizeLimit = 2000;
	private Boolean cachesDiskOffLoad = false;
	private String id;
	private String serverTTLAttribute;

	public SetIdMgrLDAPAttrCache(String id) {
