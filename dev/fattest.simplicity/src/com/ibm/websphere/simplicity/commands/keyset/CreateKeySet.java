 ...
 */
public class CreateKeySet extends Command {
	...
	public CreateKeySet(String aliasPrefix, Integer maxKeyReferences, String name, String password, String keyStoreName) {
		super("createKeySet");
		this.aliasPrefix = aliasPrefix;
		this.maxKeyReferences = maxKeyReferences;
		this.name = name;
