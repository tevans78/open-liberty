 ...
 */
public class ListGroupsInForeignBusRole extends Command {
	...
	public ListGroupsInForeignBusRole(String bus, String foreignBus, String role) {
		super("listGroupsInForeignBusRole");
		this.bus = bus;
