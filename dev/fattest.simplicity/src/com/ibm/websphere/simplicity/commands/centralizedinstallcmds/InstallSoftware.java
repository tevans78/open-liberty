 ...
 *   'installLocation': The absolute path of the directory on the target workstation where the package is to be installed.
 ...
 */
public class InstallSoftware extends Command {
	...
	public InstallSoftware(String packageName, String hostName, String platformType, String installLocation, String adminName, Boolean acceptLicense) {
	...
	/**
	 * The absolute path of the directory on the target workstation where the package is to be installed.
	 */
