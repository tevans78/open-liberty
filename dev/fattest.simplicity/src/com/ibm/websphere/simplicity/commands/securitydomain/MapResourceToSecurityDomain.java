 ...
 *   'resourceName': Specifies the resource that is to be mapped to the security domain.
 * The required parameters are found in the constructor.
 */
public class MapResourceToSecurityDomain extends Command {

	private String securityDomainName;
	private String resourceName;

	public MapResourceToSecurityDomain(String securityDomainName, String resourceName) {
