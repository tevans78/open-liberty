 ...
 *   'propertyName': See command setProcessDefinition for the supported property names. If this parameter is not specified, all properties are shown.
 * The required parameters are found in the constructor.
 */
public class ShowProcessDefinition extends Command {
