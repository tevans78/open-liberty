 ...
 *   'propertyName': Name of SSLConfig property.
 *   'sslConfigAliasName': Specifies alias that uniquely identifies a SSL configuration.
 *   'scopeName': Specifies the management scope.
 *   'propertyValue': Value of SSLConfig property.
 * The required parameters are found in the constructor.
 */
public class CreateSSLConfigProperty extends Command {
	...
	public CreateSSLConfigProperty(String propertyName, String sslConfigAliasName, String propertyValue) {
