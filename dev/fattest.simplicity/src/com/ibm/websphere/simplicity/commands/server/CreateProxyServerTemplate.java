 ...
 */
public class CreateProxyServerTemplate extends Command {
	...
	public CreateProxyServerTemplate(String templateName, String serverName, String nodeName) {
		super("createProxyServerTemplate");
