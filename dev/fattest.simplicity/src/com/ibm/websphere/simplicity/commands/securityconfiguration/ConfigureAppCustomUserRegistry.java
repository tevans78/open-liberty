 ...
 *   'customRegClass': Specifies a class name that implements the UserRegistry interface in the com.ibm.websphere.security package.
 ...
 */
public class ConfigureAppCustomUserRegistry extends Command {

	private Boolean verifyRegistry = true;
	private String realmName;
	private String securityDomainName;
	private String customRegClass;
	private String customProperties;
	private Boolean ignoreCase;

	public ConfigureAppCustomUserRegistry(String securityDomainName) {
	 ...
	 */
	public String getCustomRegClass() {
		return this.customRegClass;
	}

	/**
	 * Specifies a class name that implements the UserRegistry interface in the com.ibm.websphere.security package.
	 */
	public void setCustomRegClass(String value) {
		this.customRegClass = value;
	}
	...
	public Properties __getParameters() {
		...
		if (this.customRegClass != null) {
			ret.put("customRegClass", this.customRegClass);
		}
