 ...
 */
public class CreateIdMgrSupportedEntityType extends Command {

	private String defaultParent;
	private String rdnProperties;
	private String name;

	public CreateIdMgrSupportedEntityType(String defaultParent, String rdnProperties, String name) {
