 ...
 */
public class GetJMSConnectionFactories extends Command {

	private com.ibm.websphere.simplicity.ConfigIdentifier __target;
	private List<Command> __steps;
	private java.lang.Boolean allscopes;

	public GetJMSConnectionFactories(com.ibm.websphere.simplicity.ConfigIdentifier commandTarget, java.lang.Boolean allscopes) {
		super("getJMSConnectionFactories");
	 ...
	 */
	public OperationResults<Object> run(Scope scope, GetSIBJMSConnectionFactories getSIBJMSConnectionFactories) throws Exception {
		this.__steps = new ArrayList<Command>();
		if (getSIBJMSConnectionFactories != null)
			this.__steps.add(getSIBJMSConnectionFactories);
	 ...
	 * The required parameters are found in the constructor.
	 */
	public static class GetSIBJMSConnectionFactories extends CommandStep {

		public GetSIBJMSConnectionFactories() {
			super("getSIBJMSConnectionFactories");
		}
