 ...
 */
public class DpGetAllMSIdsUsingFirmwareVersion extends Command {

	private String firmwareVersionId;

	public DpGetAllMSIdsUsingFirmwareVersion(String firmwareVersionId) {
		super("dpGetAllMSIdsUsingFirmwareVersion");
