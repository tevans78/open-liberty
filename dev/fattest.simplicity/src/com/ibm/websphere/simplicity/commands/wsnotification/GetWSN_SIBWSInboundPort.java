 ...
 *   'type': The type of inbound port to retrieve: "BROKER" for the notification broker, "SUB_MGR" for the subscription manager or "PUB_REG_MGR" for the publisher registration manager.
 * The required parameters are found in the constructor.
 */
public class GetWSN_SIBWSInboundPort extends Command {

	private com.ibm.websphere.simplicity.ConfigIdentifier __target;
	private String type;

	public GetWSN_SIBWSInboundPort(com.ibm.websphere.simplicity.ConfigIdentifier commandTarget, String type) {
