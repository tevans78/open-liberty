 ...
 *******************************************************************************/
package io.openliberty.microprofile40.fat.suite;
...
import io.openliberty.microprofile40.fat.tests.helloworld.HelloWorldApplication;
...
public class SimpleJAXRSCDITest {
    ...
    private static final String[] MP_VERSIONS = { "4.0" };
